...
- [Projects ERD](./w5d1_erd.svg)
- Let's add the user table

- [One-To-Many Relationship](./w5d1_erd_user.png)
...
- entities
  ...
  - [Many-To-Many Relationship](./w5d2_erd-many.png)
...
- Let's do the ERD for Spotify

- [Spotify ERD created in class](./artists_db.png)